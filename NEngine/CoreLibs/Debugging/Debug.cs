...
public static class Debug
{
    ...
    {
        Application.Add(RenderLayer.BASE, new DebugLineSegment(point1, point2, secondsToLive));
    }
    public static void DrawLineSegment(Vector2f point1, Vector2f point2, Color lineColor, float secondsToLive = 0f)
    {
        Application.Add(RenderLayer.BASE, new DebugLineSegment(point1, point2, lineColor, secondsToLive));
    }
}
